        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div>
            <EmailSignup
              ...
              description="Occasional updates on the Co-Goods protocol. No spam, unsubscribe any time."
              source="footer"
            />
          </div>
        </div>

        <div className="mt-10 pt-6 border-t border-gray-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-sm text-gray-500">
