...
export const collections: Record<CollectionName, CollectionConfig> = {
  ...
  wiki: { name: 'wiki', folder: 'wiki', resolver: 'bare-slug', layout: 'WikiArticle' },
  essays: { name: 'essays', folder: 'essays', resolver: 'bare-slug', layout: 'EssayDetail' },
  reports: { name: 'reports', folder: 'reports', resolver: 'reports-versioned', layout: 'ArticleLayout' },
  insights: { name: 'insights', folder: 'insights', resolver: 'bare-slug', layout: 'InsightDetail' },
  observations: { name: 'observations', folder: 'observations', resolver: 'bare-slug', layout: 'ObservationDetail' },
  hypotheses: { name: 'hypotheses', folder: 'hypotheses', resolver: 'bare-slug', layout: 'HypothesisDetail' },
  library: { name: 'library', folder: 'library', resolver: 'library-nested', layout: 'LibraryEntry' },
  glossary: { name: 'glossary', folder: 'glossary', resolver: 'bare-slug', layout: 'GlossaryTerm' },
  blog: { name: 'blog', folder: 'blog', resolver: 'blog-flattened', layout: 'BlogPost' },
  people: { name: 'people', folder: 'people', resolver: 'bare-slug', layout: 'PersonProfile' },
